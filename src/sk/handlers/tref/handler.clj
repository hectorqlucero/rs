...
;; End get-fraccionamientos

;; Start get-constructoras
(def get-constructoras-sql
  "
   SELECT
   id AS value,
   razon_social AS text
   FROM constructoras
   ORDER BY
   razon_social
   ")
...
;; Start get-tipo_creditos
(def get-tipo-creditos-sql
  "
   SELECT
   id AS value,
   nombre AS text
...
(defn get-tipo-creditos []
  (Query db [get-tipo-creditos-sql]))
;; End get-tipo_creditos
