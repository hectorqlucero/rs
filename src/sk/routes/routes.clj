...
(defroutes open-routes
  ...
  (GET "/table_ref/get_constructoras" [] (generate-string (table_ref/get-constructoras)))
  (GET "/table_ref/get_zonas" [] (generate-string (table_ref/get-zonas)))
  (GET "/table_ref/get_tipo_creditos" [] (generate-string (table_ref/get-tipo-creditos)))
  (GET "/table_ref/get_fraccionamientos" [] (generate-string (table_ref/get-fraccionamientos)))
  (GET "/table_ref/get_tipos" [] (generate-string (table_ref/tipo_casas))))
