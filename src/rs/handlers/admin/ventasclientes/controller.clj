(ns rs.handlers.admin.ventasclientes.controller
  (:require
   [rs.handlers.admin.ventasclientes.model :refer [get-ventas get-ventas-id]]
   [rs.handlers.admin.ventasclientes.view :refer [ventas-view build-ventas-form]]
...
(defn ventasclientes-grid
  [request]
  (let [params (:params request)
  parent-id (crud-fix-id (get params :parent_id))
        title " Ventas "
        rows (get-ventas parent-id)
        content (ventas-view title rows parent-id)
