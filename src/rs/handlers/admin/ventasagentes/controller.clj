(ns rs.handlers.admin.ventasagentes.controller
  (:require
   [rs.handlers.admin.ventasagentes.model :refer [get-ventas get-ventas-id]]
   [rs.handlers.admin.ventasagentes.view :refer [ventas-view build-ventas-form]]
