(ns rs.handlers.reports.vista_documentos_por_vencer.controller
  (:require
   [rs.handlers.reports.vista_documentos_por_vencer.model :refer [get-vista_documentos_por_vencer]]
   [rs.handlers.reports.vista_documentos_por_vencer.view :refer [vista_documentos_por_vencer-view]]
...
(defn vista_documentos_por_vencer
  [request]
  (let [title "Vista_documentos_por_vencer Report"
