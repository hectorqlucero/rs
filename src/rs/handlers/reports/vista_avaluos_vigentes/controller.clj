(ns rs.handlers.reports.vista_avaluos_vigentes.controller
  (:require
   [rs.handlers.reports.vista_avaluos_vigentes.model :refer [get-vista_avaluos_vigentes]]
   [rs.handlers.reports.vista_avaluos_vigentes.view :refer [vista_avaluos_vigentes-view]]
...
(defn vista_avaluos_vigentes
  [request]
  (let [title "Vista_avaluos_vigentes Report"
